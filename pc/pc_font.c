/* pc_font.c — the CP437 character sets the text-mode renderer draws with:
 * 8x8 (43/50-line modes), 8x14 (EGA) and 8x16 (VGA), one byte per scan
 * line, bit 7 leftmost.
 *
 * Generated from SeaBIOS's vgasrc/vgafonts.c, whose header says: "These
 * fonts come from ftp://ftp.simtel.net/pub/simtelnet/msdos/screen/
 * fntcol16.zip. The package is (c) by Joseph Gil. The individual fonts
 * are public domain." Do not edit by hand.
 */
#include <stdint.h>

const uint8_t pc_font8[256 * 8] = {
...
const uint8_t pc_font14[256 * 14] = {
...
const uint8_t pc_font16[256 * 16] = {
